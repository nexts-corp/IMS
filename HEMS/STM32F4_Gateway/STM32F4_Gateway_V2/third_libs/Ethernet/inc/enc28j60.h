...
//#define disableChip  GPIO_SetBits(GPIOB,GPIO_PIN_0); Delay_us(2);
//#define enableChip   GPIO_ResetBits(GPIOB,GPIO_PIN_0); Delay_us(2);

#define disableChip  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET); Delay_us(2);
#define enableChip  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_RESET); Delay_us(2);
